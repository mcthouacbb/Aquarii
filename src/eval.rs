...
#[rustfmt::skip]
const MATERIAL: [ScorePair; 6] = [S(65,159), S(225,341), S(261,365), S(329,624), S(624,1186), S(0,0)];
#[rustfmt::skip]
const PSQT: [[ScorePair; 64]; 6] = [
    [
        S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0),
        S(73,98), S(44,104), S(30,94), S(70,66), S(47,77), S(2,108), S(19,119), S(26,103),
        S(5,68), S(7,52), S(3,39), S(33,10), S(26,12), S(-19,38), S(8,44), S(-3,64),
        S(-19,9), S(-4,-3), S(-4,-26), S(0,-34), S(11,-43), S(-2,-31), S(10,-21), S(-11,-10),
        S(-33,-22), S(-25,-22), S(-5,-50), S(-4,-48), S(-2,-55), S(-5,-51), S(-14,-34), S(-24,-38),
        S(-34,-29), S(-17,-31), S(-18,-48), S(-18,-38), S(-9,-45), S(-22,-43), S(11,-49), S(-23,-43),
        S(-34,-18), S(-9,-29), S(-18,-39), S(-27,-42), S(-13,-34), S(-4,-39), S(18,-49), S(-23,-37),
        S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0),
    ],
    [
        S(-46,-47), S(-6,-14), S(-23,-10), S(-21,4), S(30,-14), S(-59,-3), S(-16,-30), S(-8,-65),
        S(-2,-6), S(-10,4), S(7,-2), S(13,3), S(14,-1), S(15,-6), S(-37,-1), S(11,-4),
        S(14,-4), S(9,8), S(8,17), S(20,17), S(30,13), S(39,19), S(19,9), S(19,0),
        S(20,7), S(20,15), S(19,21), S(35,25), S(34,29), S(38,20), S(30,20), S(39,4),
        S(5,13), S(7,9), S(8,26), S(11,28), S(7,31), S(24,19), S(21,14), S(14,11),
        S(-21,-10), S(-6,0), S(-11,6), S(-1,18), S(5,17), S(-4,7), S(14,-3), S(-9,-9),
        S(-24,-31), S(-27,5), S(-16,-16), S(-10,7), S(-3,-2), S(-2,-7), S(-9,-2), S(-4,-15),
        S(-47,-40), S(-28,-28), S(-24,-18), S(-23,-5), S(-23,3), S(-13,-7), S(-27,-14), S(-37,-35),
    ],
    [
        S(-11,3), S(-36,6), S(-17,-5), S(-43,-1), S(-23,-6), S(-72,2), S(-20,2), S(8,-10),
        S(-26,0), S(-23,9), S(-3,1), S(-7,-6), S(-40,-2), S(6,-2), S(-52,13), S(-21,-8),
        S(11,-6), S(18,-1), S(5,19), S(26,7), S(32,3), S(33,24), S(20,9), S(31,-3),
        S(2,-7), S(9,14), S(12,18), S(30,28), S(23,27), S(21,18), S(17,9), S(13,-9),
        S(10,-11), S(1,8), S(13,19), S(18,25), S(14,21), S(12,16), S(10,8), S(16,-23),
        S(5,-12), S(16,3), S(5,14), S(4,12), S(3,11), S(11,9), S(14,-2), S(7,-8),
        S(6,-10), S(8,-11), S(6,-16), S(-8,-9), S(-2,-8), S(11,-11), S(20,-9), S(6,-41),
        S(-17,-7), S(-4,-16), S(-8,-29), S(-32,-10), S(-14,-22), S(-17,-8), S(-20,-19), S(-17,-10),
    ],
    [
        S(44,9), S(58,11), S(51,15), S(58,5), S(66,1), S(65,1), S(63,4), S(45,6),
        S(22,20), S(28,18), S(42,14), S(65,0), S(69,-3), S(67,1), S(55,9), S(49,11),
        S(-15,21), S(1,13), S(0,7), S(20,-8), S(32,-16), S(28,-8), S(32,-6), S(9,3),
        S(-25,16), S(-12,10), S(-1,5), S(-2,-2), S(11,-12), S(9,-6), S(11,-3), S(0,-9),
        S(-41,15), S(-35,20), S(-22,11), S(-28,11), S(-19,2), S(-16,1), S(-6,2), S(-26,-1),
        S(-52,13), S(-35,7), S(-46,14), S(-36,3), S(-27,-6), S(-29,-4), S(-7,-7), S(-33,-1),
        S(-61,-2), S(-42,-8), S(-38,-5), S(-40,-6), S(-34,-12), S(-31,-17), S(-12,-29), S(-40,-26),
        S(-41,-14), S(-33,-4), S(-22,-1), S(-18,-6), S(-9,-14), S(-22,-11), S(-14,-22), S(-27,-34),
    ],
    [
        S(3,6), S(23,23), S(22,23), S(5,55), S(11,67), S(57,38), S(43,26), S(45,5),
        S(-3,9), S(-23,48), S(-3,61), S(-4,66), S(9,89), S(36,82), S(6,59), S(37,24),
        S(-15,8), S(-11,14), S(-5,47), S(-6,67), S(-3,78), S(39,77), S(18,68), S(30,36),
        S(-11,-11), S(-14,26), S(-14,37), S(-22,68), S(-13,68), S(-10,64), S(0,45), S(30,-24),
        S(-7,-20), S(-24,15), S(-19,30), S(-21,49), S(-14,28), S(-8,31), S(3,9), S(1,-11),
        S(-18,-38), S(-10,-14), S(-17,6), S(-16,-13), S(-12,-11), S(-3,-8), S(3,-23), S(-4,-27),
        S(-18,-48), S(-13,-54), S(-6,-71), S(-8,-65), S(-4,-58), S(2,-85), S(10,-83), S(4,-90),
        S(-15,-70), S(-15,-89), S(-4,-102), S(-5,-72), S(4,-108), S(-6,-128), S(-19,-115), S(4,-118),
    ],
    [
        S(-54,-4), S(122,-18), S(-18,15), S(57,-32), S(120,-44), S(71,-14), S(35,42), S(8,8),
        S(7,17), S(-19,56), S(60,4), S(45,16), S(35,23), S(73,18), S(114,19), S(-44,23),
        S(-98,56), S(0,51), S(32,32), S(36,27), S(56,26), S(108,23), S(79,41), S(-91,52),
        S(-101,21), S(-62,46), S(-17,26), S(-85,46), S(-47,40), S(-52,42), S(-71,55), S(-148,43),
        S(-121,3), S(-22,16), S(-36,18), S(-46,24), S(-38,24), S(-41,23), S(-46,25), S(-143,15),
        S(-8,-30), S(34,-11), S(-8,-4), S(-13,8), S(-12,6), S(-9,-2), S(11,-5), S(-38,-14),
        S(37,-52), S(39,-35), S(27,-33), S(10,-24), S(-0,-19), S(15,-30), S(49,-36), S(40,-52),
        S(-18,-87), S(52,-62), S(43,-68), S(-17,-59), S(31,-80), S(-5,-66), S(49,-58), S(34,-93),
    ],
];
#[rustfmt::skip]
const MOBILITY: [[ScorePair; 28]; 4] = [
    [S(-33,-45), S(-30,-40), S(-14,-16), S(-5,0), S(3,11), S(7,21), S(13,25), S(24,25), S(34,19), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0)],
    [S(18,-89), S(-16,-50), S(-22,-13), S(-17,6), S(-9,11), S(-5,21), S(-4,24), S(-1,21), S(2,24), S(4,20), S(4,20), S(10,5), S(13,7), S(24,-6), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0)],
    [S(-19,-122), S(-15,-73), S(-22,-45), S(-18,-11), S(-13,5), S(-10,14), S(-8,20), S(-5,24), S(-1,24), S(5,26), S(9,27), S(13,32), S(19,33), S(21,36), S(45,9), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0)],
    [S(-211,-352), S(-193,-333), S(-102,-292), S(-20,-99), S(-4,-62), S(-25,82), S(-10,60), S(-7,62), S(-6,69), S(-5,84), S(-6,91), S(-5,98), S(-2,98), S(-1,101), S(2,98), S(4,95), S(7,92), S(7,85), S(13,75), S(17,70), S(31,46), S(36,34), S(56,12), S(85,-25), S(94,-48), S(97,-52), S(109,-66), S(39,-20)],
];
#[rustfmt::skip]
const PASSED_PAWN: [ScorePair; 8] = [S(0,0), S(1,-73), S(-8,-54), S(-20,-4), S(-7,43), S(-0,89), S(92,216), S(0,0)];
#[rustfmt::skip]
const OUR_PASSER_DIST: [ScorePair; 8] = [S(0,0), S(-7,52), S(-1,35), S(3,18), S(7,13), S(4,17), S(8,12), S(-2,15)];
#[rustfmt::skip]
const THEIR_PASSER_DIST: [ScorePair; 8] = [S(0,0), S(3,-20), S(15,13), S(5,25), S(0,36), S(-1,39), S(-2,40), S(-13,36)];
#[rustfmt::skip]
const PASSED_BLOCKED: [ScorePair; 4] = [S(5,-25), S(14,-55), S(19,-112), S(-52,-254)];
#[rustfmt::skip]
const PASSED_SAFE_ADV: [ScorePair; 4] = [S(-2,11), S(-14,39), S(-2,63), S(-9,130)];
#[rustfmt::skip]
const PAWN_PHALANX: [ScorePair; 8] = [S(0,0), S(2,-1), S(10,10), S(12,25), S(22,75), S(95,147), S(181,359), S(0,0)];
#[rustfmt::skip]
const DEFENDED_PAWN: [ScorePair; 8] = [S(0,0), S(0,0), S(13,19), S(12,18), S(18,30), S(54,67), S(156,75), S(0,0)];
#[rustfmt::skip]
const SAFE_KNIGHT_CHECK: ScorePair = S(24,1);
#[rustfmt::skip]
const SAFE_BISHOP_CHECK: ScorePair = S(12,20);
#[rustfmt::skip]
const SAFE_ROOK_CHECK: ScorePair = S(69,-3);
#[rustfmt::skip]
const SAFE_QUEEN_CHECK: ScorePair = S(29,20);
#[rustfmt::skip]
const KING_ATTACKER_WEIGHT: [ScorePair; 4] = [S(14,14), S(10,16), S(11,10), S(3,56)];
#[rustfmt::skip]
const KING_ATTACKS: [ScorePair; 14] = [S(-31,37), S(-44,16), S(-45,12), S(-46,11), S(-38,3), S(-22,-8), S(5,-20), S(44,-38), S(79,-53), S(116,-67), S(144,-78), S(208,-106), S(190,-60), S(228,0)];
#[rustfmt::skip]
const PAWN_SHIELD: [[ScorePair; 8]; 4] = [
    [S(14,5), S(-12,15), S(-14,13), S(-8,11), S(7,-5), S(6,-24), S(2,-39), S(0,0)],
    [S(8,7), S(-16,-3), S(-13,6), S(-7,6), S(7,-6), S(10,-31), S(15,-36), S(0,0)],
    [S(10,4), S(-8,-2), S(-1,1), S(2,2), S(-1,-3), S(-3,-12), S(-28,-6), S(0,0)],
    [S(6,3), S(-2,-0), S(-5,5), S(-4,8), S(-1,6), S(12,-8), S(61,-39), S(0,0)],
];
#[rustfmt::skip]
const PAWN_STORM: [[ScorePair; 8]; 4] = [
    [S(-0,25), S(-62,-38), S(28,-57), S(5,-7), S(1,14), S(-4,19), S(1,14), S(0,0)],
    [S(-0,9), S(-9,-69), S(48,-40), S(-6,-8), S(-1,-4), S(-11,5), S(-7,6), S(0,0)],
    [S(-5,8), S(39,-51), S(63,-47), S(6,-8), S(-4,6), S(-7,9), S(-5,8), S(0,0)],
    [S(3,5), S(44,-58), S(3,-18), S(1,3), S(1,10), S(-4,6), S(-6,9), S(0,0)],
];
#[rustfmt::skip]
const THREAT_BY_PAWN: [[ScorePair; 6]; 2] = [
    [S(-21,-70), S(62,47), S(51,66), S(53,42), S(26,68), S(0,0)],
    [S(-18,-51), S(120,218), S(130,261), S(130,466), S(257,1195), S(0,0)],
];
#[rustfmt::skip]
const THREAT_BY_KNIGHT: [[[ScorePair; 6]; 2]; 2] = [
    [
        [S(9,36), S(-14,-40), S(36,57), S(56,48), S(58,10), S(0,0)],
        [S(0,15), S(-21,-53), S(28,42), S(38,45), S(40,65), S(0,0)],
    ],
    [
        [S(16,52), S(25,36), S(81,178), S(65,392), S(249,1050), S(0,0)],
        [S(-7,13), S(-16,-47), S(37,50), S(64,185), S(179,802), S(0,0)],
    ],
];
#[rustfmt::skip]
const THREAT_BY_BISHOP: [[[ScorePair; 6]; 2]; 2] = [
    [
        [S(7,29), S(41,67), S(-4,-11), S(55,62), S(77,86), S(0,0)],
        [S(-0,7), S(24,43), S(-20,-33), S(38,78), S(57,134), S(0,0)],
    ],
    [
        [S(21,50), S(75,185), S(41,66), S(124,402), S(211,1075), S(0,0)],
        [S(-5,5), S(19,45), S(-21,-30), S(63,220), S(252,682), S(0,0)],
    ],
];
#[rustfmt::skip]
const THREAT_BY_ROOK: [[[ScorePair; 6]; 2]; 2] = [
    [
        [S(1,58), S(38,76), S(56,77), S(-62,-191), S(94,40), S(0,0)],
        [S(-7,29), S(11,30), S(21,32), S(-76,-204), S(66,117), S(0,0)],
    ],
    [
        [S(7,75), S(51,208), S(86,240), S(-31,273), S(215,1293), S(0,0)],
        [S(-9,13), S(15,10), S(24,11), S(-64,-215), S(209,643), S(0,0)],
    ],
];
#[rustfmt::skip]
const THREAT_BY_QUEEN: [[[ScorePair; 6]; 2]; 2] = [
    [
        [S(15,-1), S(36,20), S(35,59), S(47,40), S(-73,-330), S(0,0)],
        [S(-1,-1), S(2,1), S(4,9), S(3,14), S(-110,-325), S(0,0)],
    ],
    [
        [S(19,56), S(72,187), S(111,218), S(146,427), S(122,756), S(0,0)],
        [S(-6,4), S(-1,-2), S(1,7), S(-4,11), S(-107,-316), S(0,0)],
    ],
];
#[rustfmt::skip]
const PUSH_THREAT: [ScorePair; 2] = [S(9,11), S(15,13)];
#[rustfmt::skip]
const TEMPO: i32 = 18;
