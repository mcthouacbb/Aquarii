...
#[rustfmt::skip]
const MATERIAL: [ScorePair; 6] = [S(67,149), S(235,329), S(265,354), S(343,604), S(658,1140), S(0,0)];
#[rustfmt::skip]
const PSQT: [[ScorePair; 64]; 6] = [
    [
        S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0),
        S(64,80), S(56,87), S(41,81), S(81,46), S(48,65), S(2,83), S(8,91), S(2,91),
        S(-3,69), S(0,64), S(5,50), S(32,18), S(27,17), S(-10,35), S(14,50), S(-6,59),
        S(-21,6), S(-4,-2), S(-2,-27), S(-1,-31), S(13,-40), S(2,-34), S(14,-22), S(-9,-13),
        S(-35,-20), S(-20,-21), S(-9,-44), S(-4,-42), S(-1,-49), S(-5,-46), S(-11,-31), S(-21,-37),
        S(-37,-27), S(-17,-26), S(-19,-42), S(-19,-30), S(-8,-39), S(-20,-39), S(13,-41), S(-19,-39),
        S(-39,-16), S(-14,-22), S(-22,-32), S(-27,-37), S(-14,-29), S(-3,-35), S(20,-41), S(-24,-37),
        S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0),
    ],
    [
        S(-70,-54), S(-19,-17), S(-6,-27), S(25,-24), S(54,-30), S(-68,-1), S(-45,-29), S(-36,-52),
        S(-9,2), S(2,0), S(19,-8), S(4,12), S(23,1), S(17,-2), S(-27,5), S(10,-17),
        S(21,-13), S(14,3), S(11,20), S(31,22), S(32,21), S(51,19), S(24,6), S(20,2),
        S(16,1), S(15,17), S(23,25), S(37,29), S(33,31), S(36,28), S(24,22), S(36,3),
        S(-1,12), S(5,7), S(10,31), S(12,34), S(11,34), S(22,24), S(18,14), S(9,8),
        S(-24,-14), S(-7,1), S(-6,9), S(1,24), S(7,22), S(-2,10), S(11,-4), S(-12,-7),
        S(-29,-29), S(-29,-0), S(-14,-12), S(-9,5), S(-3,-1), S(-1,-9), S(-14,0), S(-7,-13),
        S(-54,-32), S(-33,-28), S(-28,-16), S(-25,-5), S(-25,1), S(-14,-6), S(-33,-14), S(-35,-42),
    ],
    [
        S(-10,0), S(-44,14), S(-34,-5), S(-40,4), S(-48,-4), S(-80,15), S(-27,8), S(-13,9),
        S(-11,-10), S(-7,-2), S(-1,2), S(-2,-5), S(-31,3), S(-0,4), S(-32,-2), S(-3,-27),
        S(13,-8), S(23,-6), S(10,18), S(29,4), S(29,4), S(31,22), S(20,2), S(31,-0),
        S(4,-2), S(9,12), S(14,15), S(29,20), S(23,26), S(20,18), S(18,9), S(16,-13),
        S(9,-12), S(-2,8), S(9,19), S(19,25), S(15,22), S(11,16), S(5,14), S(13,-22),
        S(5,-8), S(10,4), S(2,13), S(6,11), S(5,11), S(7,9), S(11,-4), S(10,-13),
        S(5,-7), S(5,-9), S(7,-13), S(-7,-5), S(-2,-3), S(11,-10), S(19,-7), S(5,-37),
        S(-12,-15), S(-6,-15), S(-9,-26), S(-31,-7), S(-15,-16), S(-20,-5), S(-7,-15), S(-13,-24),
    ],
    [
        S(38,14), S(60,9), S(52,10), S(33,16), S(37,14), S(26,16), S(46,10), S(38,12),
        S(10,17), S(24,11), S(33,10), S(58,-3), S(61,-3), S(54,-2), S(54,-2), S(58,-3),
        S(-17,18), S(6,6), S(1,3), S(25,-12), S(30,-16), S(24,-13), S(33,-10), S(23,-2),
        S(-18,12), S(-11,10), S(-6,8), S(-9,5), S(12,-12), S(6,-5), S(10,-4), S(10,-9),
        S(-37,14), S(-38,18), S(-21,12), S(-24,12), S(-19,6), S(-16,-2), S(-8,-3), S(-23,-2),
        S(-49,9), S(-33,4), S(-34,11), S(-36,10), S(-27,2), S(-27,-7), S(-7,-7), S(-28,-5),
        S(-51,-1), S(-38,-5), S(-28,-3), S(-28,-4), S(-23,-8), S(-23,-16), S(-7,-24), S(-29,-27),
        S(-32,-13), S(-28,-4), S(-21,2), S(-13,-3), S(-7,-11), S(-18,-10), S(-6,-21), S(-21,-26),
    ],
    [
        S(1,-6), S(9,41), S(10,12), S(-8,33), S(11,50), S(77,26), S(25,30), S(18,7),
        S(-5,-2), S(-29,43), S(-8,55), S(-13,67), S(23,45), S(17,74), S(4,23), S(40,-1),
        S(-2,-16), S(-8,-4), S(-9,39), S(3,45), S(6,49), S(33,72), S(27,47), S(41,8),
        S(-15,-3), S(-9,18), S(-20,44), S(-19,56), S(-13,61), S(-5,50), S(-2,52), S(45,-54),
        S(-7,-16), S(-19,16), S(-21,37), S(-16,45), S(-8,22), S(-9,35), S(4,13), S(6,-13),
        S(-16,-32), S(-10,-15), S(-15,13), S(-13,-5), S(-11,-2), S(-3,-6), S(2,-7), S(1,-36),
        S(-23,-16), S(-13,-29), S(1,-66), S(-3,-52), S(-1,-46), S(8,-72), S(11,-70), S(12,-98),
        S(-12,-63), S(-19,-62), S(-11,-71), S(-3,-58), S(-4,-59), S(-15,-76), S(-19,-74), S(-1,-99),
    ],
    [
        S(1,-82), S(11,-10), S(30,-34), S(107,-63), S(20,-29), S(2,4), S(77,13), S(52,-23),
        S(-103,35), S(-50,65), S(-55,49), S(67,10), S(38,23), S(43,28), S(31,61), S(-175,76),
        S(-42,13), S(-27,52), S(39,19), S(-11,27), S(15,28), S(41,41), S(30,58), S(-105,56),
        S(-88,21), S(-53,46), S(-1,24), S(-73,26), S(-20,25), S(-41,37), S(-98,64), S(-74,25),
        S(-57,-11), S(15,13), S(-47,14), S(-51,22), S(-30,18), S(-37,23), S(-49,28), S(-83,13),
        S(39,-34), S(30,0), S(-10,1), S(-6,4), S(-19,7), S(-6,-1), S(11,3), S(-15,-9),
        S(63,-46), S(50,-25), S(44,-31), S(23,-28), S(13,-23), S(33,-28), S(60,-27), S(56,-41),
        S(34,-83), S(77,-59), S(71,-63), S(2,-54), S(52,-77), S(19,-59), S(69,-50), S(61,-80),
    ],
];
#[rustfmt::skip]
const MOBILITY: [[ScorePair; 28]; 4] = [
    [S(-14,-58), S(-31,-47), S(-16,-10), S(-6,4), S(2,15), S(5,25), S(11,27), S(20,27), S(30,17), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0)],
    [S(-5,-23), S(-10,-70), S(-21,-17), S(-15,2), S(-7,6), S(-2,16), S(-1,21), S(3,18), S(4,19), S(10,14), S(6,16), S(18,3), S(10,4), S(11,-8), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0)],
    [S(138,-140), S(-30,-63), S(-25,-45), S(-22,-15), S(-20,1), S(-19,10), S(-17,17), S(-15,21), S(-12,24), S(-6,26), S(-5,31), S(-1,33), S(4,37), S(5,43), S(24,21), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0), S(0,0)],
    [S(-213,-340), S(-213,-340), S(-75,-274), S(-3,-149), S(2,-32), S(-23,90), S(-4,38), S(1,55), S(2,63), S(3,77), S(2,80), S(4,87), S(5,91), S(8,97), S(8,90), S(10,86), S(11,86), S(14,79), S(18,72), S(26,58), S(31,46), S(42,29), S(50,22), S(87,-16), S(83,-34), S(67,-15), S(14,-3), S(46,-43)],
];
#[rustfmt::skip]
const PASSED_PAWN: [ScorePair; 8] = [S(0,0), S(-3,-60), S(-12,-46), S(-23,-2), S(-4,35), S(9,61), S(91,176), S(0,0)];
#[rustfmt::skip]
const OUR_PASSER_DIST: [ScorePair; 8] = [S(0,0), S(-6,43), S(2,27), S(5,18), S(8,16), S(5,18), S(5,21), S(0,18)];
#[rustfmt::skip]
const THEIR_PASSER_DIST: [ScorePair; 8] = [S(0,0), S(21,-9), S(10,19), S(4,27), S(1,32), S(-1,33), S(-2,33), S(-4,28)];
#[rustfmt::skip]
const PASSED_BLOCKED: [ScorePair; 4] = [S(1,-14), S(13,-37), S(20,-84), S(-40,-202)];
#[rustfmt::skip]
const PASSED_SAFE_ADV: [ScorePair; 4] = [S(1,3), S(-13,29), S(-14,54), S(-19,110)];
#[rustfmt::skip]
const PAWN_PHALANX: [ScorePair; 8] = [S(0,0), S(4,-1), S(11,9), S(13,27), S(22,78), S(121,172), S(242,276), S(0,0)];
#[rustfmt::skip]
const DEFENDED_PAWN: [ScorePair; 8] = [S(0,0), S(0,0), S(13,19), S(11,19), S(17,30), S(60,75), S(162,85), S(0,0)];
#[rustfmt::skip]
const SAFE_KNIGHT_CHECK: ScorePair = S(26,2);
#[rustfmt::skip]
const SAFE_BISHOP_CHECK: ScorePair = S(8,14);
#[rustfmt::skip]
const SAFE_ROOK_CHECK: ScorePair = S(53,1);
#[rustfmt::skip]
const SAFE_QUEEN_CHECK: ScorePair = S(28,17);
#[rustfmt::skip]
const KING_ATTACKER_WEIGHT: [ScorePair; 4] = [S(13,10), S(8,14), S(12,6), S(1,53)];
#[rustfmt::skip]
const KING_ATTACKS: [ScorePair; 14] = [S(-27,29), S(-38,13), S(-39,11), S(-39,9), S(-31,2), S(-15,-11), S(8,-22), S(44,-38), S(89,-59), S(108,-44), S(146,-78), S(137,-43), S(243,-114), S(180,-49)];
#[rustfmt::skip]
const PAWN_SHIELD: [[ScorePair; 8]; 4] = [
    [S(6,7), S(-8,9), S(-9,9), S(-6,8), S(4,-2), S(6,-18), S(7,-34), S(0,0)],
    [S(5,4), S(-6,-4), S(-4,1), S(-6,5), S(6,-3), S(6,-18), S(4,-15), S(0,0)],
    [S(7,2), S(-2,-1), S(2,-2), S(3,0), S(0,-2), S(-13,4), S(-10,-18), S(0,0)],
    [S(7,1), S(2,-5), S(-2,2), S(-1,3), S(-0,3), S(10,-7), S(51,-24), S(0,0)],
];
#[rustfmt::skip]
const PAWN_STORM: [[ScorePair; 8]; 4] = [
    [S(-4,22), S(-43,-24), S(15,-31), S(-1,3), S(-5,16), S(-6,18), S(-4,14), S(0,0)],
    [S(-0,7), S(-3,-44), S(28,-21), S(-5,-1), S(0,-1), S(-6,4), S(-4,6), S(0,0)],
    [S(-3,6), S(36,-42), S(43,-28), S(1,-1), S(-3,5), S(-5,7), S(-3,5), S(0,0)],
    [S(2,1), S(74,-54), S(-2,-12), S(2,-0), S(1,3), S(-0,1), S(-4,5), S(0,0)],
];
#[rustfmt::skip]
const THREAT_BY_PAWN: [[ScorePair; 6]; 2] = [
    [S(-24,-88), S(62,39), S(49,48), S(43,58), S(-31,243), S(0,0)],
    [S(-19,-69), S(130,206), S(146,231), S(131,499), S(363,1219), S(0,0)],
];
#[rustfmt::skip]
const THREAT_BY_KNIGHT: [[[ScorePair; 6]; 2]; 2] = [
    [
        [S(10,36), S(-8,-45), S(32,53), S(51,43), S(56,69), S(0,0)],
        [S(-1,13), S(-20,-59), S(30,37), S(36,56), S(34,98), S(0,0)],
    ],
    [
        [S(17,51), S(28,20), S(96,165), S(69,422), S(228,1034), S(0,0)],
        [S(-7,9), S(-17,-53), S(35,51), S(56,207), S(252,598), S(0,0)],
    ],
];
#[rustfmt::skip]
const THREAT_BY_BISHOP: [[[ScorePair; 6]; 2]; 2] = [
    [
        [S(6,27), S(51,55), S(-10,-15), S(47,58), S(77,77), S(0,0)],
        [S(0,7), S(25,44), S(-23,-22), S(38,85), S(63,121), S(0,0)],
    ],
    [
        [S(24,46), S(89,160), S(53,53), S(127,437), S(353,767), S(0,0)],
        [S(-6,4), S(23,46), S(-24,-23), S(61,226), S(296,469), S(0,0)],
    ],
];
#[rustfmt::skip]
const THREAT_BY_ROOK: [[[ScorePair; 6]; 2]; 2] = [
    [
        [S(3,56), S(45,58), S(57,66), S(-37,-216), S(70,90), S(0,0)],
        [S(-5,26), S(12,27), S(25,23), S(-36,-236), S(98,64), S(0,0)],
    ],
    [
        [S(2,78), S(65,192), S(91,223), S(-3,225), S(296,1178), S(0,0)],
        [S(-8,10), S(11,7), S(25,2), S(-30,-244), S(221,654), S(0,0)],
    ],
];
#[rustfmt::skip]
const THREAT_BY_QUEEN: [[[ScorePair; 6]; 2]; 2] = [
    [
        [S(13,-3), S(37,10), S(49,43), S(56,29), S(-100,-268), S(0,0)],
        [S(-2,2), S(4,3), S(9,-11), S(2,15), S(-156,-224), S(0,0)],
    ],
    [
        [S(23,44), S(76,163), S(125,160), S(248,246), S(315,615), S(0,0)],
        [S(-4,3), S(-4,4), S(0,5), S(-2,-3), S(-147,-242), S(0,0)],
    ],
];
#[rustfmt::skip]
const PUSH_THREAT: [ScorePair; 2] = [S(4,9), S(12,6)];
#[rustfmt::skip]
const TEMPO: i32 = 18;
